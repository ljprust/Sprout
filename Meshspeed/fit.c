...
void set_W( struct domain * theDomain , int reset ){
   ...
   double yr, timesec, timeyrs;
   double fitparam1, fitparam2;
   double Wyr, Wsec;

   yr = 364.25*24.0*3600.0;
   timesec = theDomain->t;
   timeyrs = timesec/yr;
   fitparam1 =  1.24261145;
   fitparam2 = -1.12721357;

   Wyr = fitparam1*pow(timeyrs, fitparam2); // 1/yr
   Wsec = Wyr/yr;                           // 1/sec
